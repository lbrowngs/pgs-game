...
class baking():
   ...
   def bakingAisle(self):
        ...
        if flourChoice == "A":
            ...
            print(f"{name} turns toward the flour hoarder and points out the sign that says '1 bag per customer.' \nThe man explodes with rage and grabs the last bag of flour from the shelf, throwing it at {name}.")
            conf.change(-10)
        elif flourChoice == "C":
            print(f"{name} quickly grabs the last bag of flour and finds an employee further down the aisle. \nThey alert the employee to the flour hoarding situation, and are thanked for their efforts.")
            conf.change(3)
