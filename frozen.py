...
class frozen():
    ...
    def frozen_aisle(self):
        ...
        # frozen scenario
        print(f"\n{name} arrives to the frozen section and hears loud yelling. {name} notices a man in a red hat shouting “5G is killing our kids!”. ")
        ...
        if red_hat == "A" and item == "headphones":
            ...
            print(f"{name} is brave but not smart, Red Hat Man spits as he yells at {name} causing a potential Covid spreading situation. ")
            conf.change(-20)
        elif red_hat == "C":
